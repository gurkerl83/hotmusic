package cz.hotmusic.lib.command.addartist
{
	...
	public class ChangeStateAddArtistCommand implements ICommand, IResponder
	{
		public function ChangeStateAddArtistCommand()
		{
		}
		...
		public function execute(event:CairngormEvent):void
		{
			...
			var call:AsyncToken = service.changeState(se.sid, se.addArtist);
