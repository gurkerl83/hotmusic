package cz.hotmusic.lib.command.profile
{
	...
	public class TotalSongsUserCommand implements ICommand, IResponder
	{
		public function TotalSongsUserCommand()
		{
		}
		...
		public function execute(event:CairngormEvent):void
		{
			...
			var call:AsyncToken = service.listTotalAddedSongs(se.sid);
