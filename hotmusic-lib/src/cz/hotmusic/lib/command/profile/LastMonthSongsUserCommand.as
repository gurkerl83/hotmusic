package cz.hotmusic.lib.command.profile
{
	...
	public class LastMonthSongsUserCommand implements ICommand, IResponder
	{
		public function LastMonthSongsUserCommand()
		{
		}
		...
		public function execute(event:CairngormEvent):void
		{
			...
			var call:AsyncToken = service.listLastMonthAddedSongs(se.sid);
