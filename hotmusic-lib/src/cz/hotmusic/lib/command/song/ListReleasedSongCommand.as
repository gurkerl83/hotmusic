package cz.hotmusic.lib.command.song
{
	...
	public class ListReleasedSongCommand implements ICommand, IResponder
	{
		public function ListReleasedSongCommand()
		{
		}
		...
		public function execute(event:CairngormEvent):void
		{
			...
			var call:AsyncToken = service.listReleased(se.sid);
