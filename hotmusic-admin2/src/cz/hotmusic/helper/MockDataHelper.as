package cz.hotmusic.helper
{
	...
	{
		public function MockDataHelper()
		{
		}
		
		private static var _instance:MockDataHelper;
		public static function getInstance():MockDataHelper 
		{
			if (_instance == null) {
				_instance = new MockDataHelper();
				_instance.init();
			}
			return _instance;
		}
